...
#ifndef __DA1470X_ANAMISC_BIF_H
#define __DA1470X_ANAMISC_BIF_H
...
#define DA1470X_ANAMISC_BIF_BASE                0x50050600 /* ANAMISC_BIF registers */

#define DA1470X_ANAMISC_BIF_CLK_CAL_IRQ         (DA1470X_ANAMISC_BIF_BASE + DA1470X_ANAMISC_BIF_CLK_CAL_IRQ_OFFSET) /* Select clock for oscillator calibration */
#define DA1470X_ANAMISC_BIF_CLK_REF_CNT         (DA1470X_ANAMISC_BIF_BASE + DA1470X_ANAMISC_BIF_CLK_REF_CNT_OFFSET) /* Count value for oscillator calibration */
#define DA1470X_ANAMISC_BIF_CLK_REF_SEL         (DA1470X_ANAMISC_BIF_BASE + DA1470X_ANAMISC_BIF_CLK_REF_SEL_OFFSET) /* Select clock for oscillator calibration */
#define DA1470X_ANAMISC_BIF_CLK_REF_VAL         (DA1470X_ANAMISC_BIF_BASE + DA1470X_ANAMISC_BIF_CLK_REF_VAL_OFFSET) /* DIVN reference cycles, lower 16 bits */
...
#define ANAMISC_BIF_REF_CAL_START               (1U << 3) /* Writing a 1 starts a calibration. This bit is cleared when calibration is finish */
