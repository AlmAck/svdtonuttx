...
#ifndef __DA1470X_AES_HASH_H
#define __DA1470X_AES_HASH_H
...
#define DA1470X_AES_HASH_CRYPTO_CLRIRQ_OFFSET      0x0018 /* Crypto Clear interrupt request */
#define DA1470X_AES_HASH_CRYPTO_CTRL_OFFSET        0x0000 /* Crypto Control register */
#define DA1470X_AES_HASH_CRYPTO_DEST_ADDR_OFFSET   0x0010 /* Crypto DMA destination memory */
#define DA1470X_AES_HASH_CRYPTO_FETCH_ADDR_OFFSET  0x0008 /* Crypto DMA fetch register */
#define DA1470X_AES_HASH_CRYPTO_KEYS_START_OFFSET  0x0100 /* Crypto First position of the AES keys storage memory */
#define DA1470X_AES_HASH_CRYPTO_LEN_OFFSET         0x000C /* Crypto Length of the input block in bytes */
#define DA1470X_AES_HASH_CRYPTO_MREG0_OFFSET       0x001C /* Crypto Mode depended register 0 */
#define DA1470X_AES_HASH_CRYPTO_MREG1_OFFSET       0x0020 /* Crypto Mode depended register 1 */
#define DA1470X_AES_HASH_CRYPTO_MREG2_OFFSET       0x0024 /* Crypto Mode depended register 2 */
#define DA1470X_AES_HASH_CRYPTO_MREG3_OFFSET       0x0028 /* Crypto Mode depended register 3 */
#define DA1470X_AES_HASH_CRYPTO_START_OFFSET       0x0004 /* Crypto Start calculation */
#define DA1470X_AES_HASH_CRYPTO_STATUS_OFFSET      0x0014 /* Crypto Status register */

/* Register addresses *******************************************************/

#define DA1470X_AES_HASH_BASE                      0x30040000 /* AES_HASH registers */

#define DA1470X_AES_HASH_CRYPTO_CLRIRQ             (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_CLRIRQ_OFFSET) /* Crypto Clear interrupt request */
#define DA1470X_AES_HASH_CRYPTO_CTRL               (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_CTRL_OFFSET) /* Crypto Control register */
#define DA1470X_AES_HASH_CRYPTO_DEST_ADDR          (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_DEST_ADDR_OFFSET) /* Crypto DMA destination memory */
#define DA1470X_AES_HASH_CRYPTO_FETCH_ADDR         (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_FETCH_ADDR_OFFSET) /* Crypto DMA fetch register */
#define DA1470X_AES_HASH_CRYPTO_KEYS_START         (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_KEYS_START_OFFSET) /* Crypto First position of the AES keys storage memory */
#define DA1470X_AES_HASH_CRYPTO_LEN                (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_LEN_OFFSET) /* Crypto Length of the input block in bytes */
#define DA1470X_AES_HASH_CRYPTO_MREG0              (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_MREG0_OFFSET) /* Crypto Mode depended register 0 */
#define DA1470X_AES_HASH_CRYPTO_MREG1              (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_MREG1_OFFSET) /* Crypto Mode depended register 1 */
#define DA1470X_AES_HASH_CRYPTO_MREG2              (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_MREG2_OFFSET) /* Crypto Mode depended register 2 */
#define DA1470X_AES_HASH_CRYPTO_MREG3              (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_MREG3_OFFSET) /* Crypto Mode depended register 3 */
#define DA1470X_AES_HASH_CRYPTO_START              (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_START_OFFSET) /* Crypto Start calculation */
#define DA1470X_AES_HASH_CRYPTO_STATUS             (DA1470X_AES_HASH_BASE + DA1470X_AES_HASH_CRYPTO_STATUS_OFFSET) /* Crypto Status register */
