...
#define DA1470X_CRG_VSYS_VSYS_GEN_CTRL_OFFSET        0x0000 /* No description available. */
#define DA1470X_CRG_VSYS_VSYS_GEN_IRQ_CLEAR_OFFSET   0x0008 /* No description available. */
#define DA1470X_CRG_VSYS_VSYS_GEN_IRQ_MASK_OFFSET    0x000C /* No description available. */
#define DA1470X_CRG_VSYS_VSYS_GEN_IRQ_STATUS_OFFSET  0x0004 /* No description available. */

/* Register addresses *******************************************************/

#define DA1470X_CRG_VSYS_BASE                        0x50000B00 /* CRG_VSYS registers */

#define DA1470X_CRG_VSYS_VSYS_GEN_CTRL               (DA1470X_CRG_VSYS_BASE + DA1470X_CRG_VSYS_VSYS_GEN_CTRL_OFFSET) /* No description available. */
#define DA1470X_CRG_VSYS_VSYS_GEN_IRQ_CLEAR          (DA1470X_CRG_VSYS_BASE + DA1470X_CRG_VSYS_VSYS_GEN_IRQ_CLEAR_OFFSET) /* No description available. */
#define DA1470X_CRG_VSYS_VSYS_GEN_IRQ_MASK           (DA1470X_CRG_VSYS_BASE + DA1470X_CRG_VSYS_VSYS_GEN_IRQ_MASK_OFFSET) /* No description available. */
#define DA1470X_CRG_VSYS_VSYS_GEN_IRQ_STATUS         (DA1470X_CRG_VSYS_BASE + DA1470X_CRG_VSYS_VSYS_GEN_IRQ_STATUS_OFFSET) /* No description available. */
