...
#define DA1470X_CRG_GPU_BASE                  0x51001000 /* CRG_GPU registers */

#define DA1470X_CRG_GPU_CLK_GPU               (DA1470X_CRG_GPU_BASE + DA1470X_CRG_GPU_CLK_GPU_OFFSET) /* Control register for clocks in PD_GPU */
