...
#define DA1470X_CRG_SYS_BATCHECK_OFFSET       0x0010 /* No description available. */
...
#define DA1470X_CRG_SYS_BASE                  0x50040400 /* CRG_SYS registers */

#define DA1470X_CRG_SYS_BATCHECK              (DA1470X_CRG_SYS_BASE + DA1470X_CRG_SYS_BATCHECK_OFFSET) /* No description available. */
#define DA1470X_CRG_SYS_CLK_SYS               (DA1470X_CRG_SYS_BASE + DA1470X_CRG_SYS_CLK_SYS_OFFSET) /* Peripheral divider register */
#define DA1470X_CRG_SYS_RESET_CLK_SYS         (DA1470X_CRG_SYS_BASE + DA1470X_CRG_SYS_RESET_CLK_SYS_OFFSET) /* Peripheral divider RESET register */
#define DA1470X_CRG_SYS_SET_CLK_SYS           (DA1470X_CRG_SYS_BASE + DA1470X_CRG_SYS_SET_CLK_SYS_OFFSET) /* Peripheral divider SET register */
...
#define CRG_SYS_BATCHECK_TRIM_MASK            (0xF << 0) /* Trim the current load with steps of 2.7 % from -19.1 % to +19.1 %. 0: +0.0 % , 8 */
#define CRG_SYS_BATCHECK_TRIM_POS             (0) /* Trim the current load with steps of 2.7 % from -19.1 % to +19.1 %. 0: +0.0 % , 8 */
