...
#define DA1470X_CHARGER_CHARGER_CC_CHARGE_TIMER_OFFSET     0x0028 /* Maximum CC-charge time limit register */
#define DA1470X_CHARGER_CHARGER_CTRL_OFFSET                0x0000 /* Charger main control register */
#define DA1470X_CHARGER_CHARGER_CURRENT_PARAM_OFFSET       0x0010 /* Charger current settings register */
#define DA1470X_CHARGER_CHARGER_CURRENT_STATUS_OFFSET      0x0018 /* Charger current status register */
#define DA1470X_CHARGER_CHARGER_CV_CHARGE_TIMER_OFFSET     0x002C /* Maximum CV-charge time limit register */
#define DA1470X_CHARGER_CHARGER_ERROR_IRQ_CLR_OFFSET       0x007C /* Interrupt clear register of Charger Error IRQs */
#define DA1470X_CHARGER_CHARGER_ERROR_IRQ_MASK_OFFSET      0x006C /* Mask register of Charger Error IRQs */
#define DA1470X_CHARGER_CHARGER_ERROR_IRQ_STATUS_OFFSET    0x0074 /* Status register of Charger Error IRQs */
#define DA1470X_CHARGER_CHARGER_JEITA_CURRENT2_OFFSET      0x0048 /* JEITA-compliant current settings register for "Cooler" and "Warmer" zones */
#define DA1470X_CHARGER_CHARGER_JEITA_CURRENT_OFFSET       0x0044 /* JEITA-compliant current settings register */
#define DA1470X_CHARGER_CHARGER_JEITA_V_CHARGE_OFFSET      0x0034 /* JEITA-compliant Charge voltage settings register */
#define DA1470X_CHARGER_CHARGER_JEITA_V_OVP_OFFSET         0x0040 /* JEITA-compliant OVP settings register */
#define DA1470X_CHARGER_CHARGER_JEITA_V_PRECHARGE_OFFSET   0x0038 /* JEITA-compliant Pre-Charge voltage settings register */
#define DA1470X_CHARGER_CHARGER_JEITA_V_REPLENISH_OFFSET   0x003C /* JEITA-compliant Replenish settings register */
#define DA1470X_CHARGER_CHARGER_LOCK_OFFSET                0x0080 /* Charger HW lock register */
#define DA1470X_CHARGER_CHARGER_PRE_CHARGE_TIMER_OFFSET    0x0024 /* Maximum pre-charge time limit register */
#define DA1470X_CHARGER_CHARGER_PWR_UP_TIMER_OFFSET        0x0064 /* Charger power-up settling timer register */
#define DA1470X_CHARGER_CHARGER_STATE_IRQ_CLR_OFFSET       0x0078 /* Interrupt clear register of Charger FSM IRQs */
#define DA1470X_CHARGER_CHARGER_STATE_IRQ_MASK_OFFSET      0x0068 /* Mask register of Charger FSM IRQs */
#define DA1470X_CHARGER_CHARGER_STATE_IRQ_STATUS_OFFSET    0x0070 /* Status register of Charger FSM IRQs */
#define DA1470X_CHARGER_CHARGER_STATUS_OFFSET              0x0008 /* Charger main status register */
#define DA1470X_CHARGER_CHARGER_SWLOCK_OFFSET              0x0084 /* Charger SW lock register */
#define DA1470X_CHARGER_CHARGER_TBAT_COMP_TIMER_OFFSET     0x005C /* Battery temperature (main) comparator timer register */
#define DA1470X_CHARGER_CHARGER_TBAT_MON_TIMER_OFFSET      0x0058 /* Battery temperature monitor interval timer register */
#define DA1470X_CHARGER_CHARGER_TDIE_COMP_TIMER_OFFSET     0x0054 /* Die temperature comparator timer register */
#define DA1470X_CHARGER_CHARGER_TEMPSET2_PARAM_OFFSET      0x0020 /* Charger battery temperature settings register (Cooler, Warmer). */
#define DA1470X_CHARGER_CHARGER_TEMPSET_PARAM_OFFSET       0x001C /* Charger battery temperature settings register */
#define DA1470X_CHARGER_CHARGER_THOT_COMP_TIMER_OFFSET     0x0060 /* Battery temperature comparator timer register for "Hot" zone */
#define DA1470X_CHARGER_CHARGER_TOTAL_CHARGE_TIMER_OFFSET  0x0030 /* Maximum total charge time limit register */
#define DA1470X_CHARGER_CHARGER_VBAT_COMP_TIMER_OFFSET     0x004C /* Main Vbat comparator timer register */
#define DA1470X_CHARGER_CHARGER_VOLTAGE_PARAM_OFFSET       0x000C /* Charger voltage settings register */
#define DA1470X_CHARGER_CHARGER_VOLTAGE_STATUS_OFFSET      0x0014 /* Charger voltage status register */
#define DA1470X_CHARGER_CHARGER_VOVP_COMP_TIMER_OFFSET     0x0050 /* Vbat OVP comparator timer register */

/* Register addresses *******************************************************/

#define DA1470X_CHARGER_BASE                               0x51000600 /* CHARGER registers */

#define DA1470X_CHARGER_CHARGER_CC_CHARGE_TIMER            (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_CC_CHARGE_TIMER_OFFSET) /* Maximum CC-charge time limit register */
#define DA1470X_CHARGER_CHARGER_CTRL                       (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_CTRL_OFFSET) /* Charger main control register */
#define DA1470X_CHARGER_CHARGER_CURRENT_PARAM              (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_CURRENT_PARAM_OFFSET) /* Charger current settings register */
#define DA1470X_CHARGER_CHARGER_CURRENT_STATUS             (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_CURRENT_STATUS_OFFSET) /* Charger current status register */
#define DA1470X_CHARGER_CHARGER_CV_CHARGE_TIMER            (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_CV_CHARGE_TIMER_OFFSET) /* Maximum CV-charge time limit register */
#define DA1470X_CHARGER_CHARGER_ERROR_IRQ_CLR              (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_ERROR_IRQ_CLR_OFFSET) /* Interrupt clear register of Charger Error IRQs */
#define DA1470X_CHARGER_CHARGER_ERROR_IRQ_MASK             (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_ERROR_IRQ_MASK_OFFSET) /* Mask register of Charger Error IRQs */
#define DA1470X_CHARGER_CHARGER_ERROR_IRQ_STATUS           (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_ERROR_IRQ_STATUS_OFFSET) /* Status register of Charger Error IRQs */
#define DA1470X_CHARGER_CHARGER_JEITA_CURRENT2             (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_JEITA_CURRENT2_OFFSET) /* JEITA-compliant current settings register for "Cooler" and "Warmer" zones */
#define DA1470X_CHARGER_CHARGER_JEITA_CURRENT              (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_JEITA_CURRENT_OFFSET) /* JEITA-compliant current settings register */
#define DA1470X_CHARGER_CHARGER_JEITA_V_CHARGE             (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_JEITA_V_CHARGE_OFFSET) /* JEITA-compliant Charge voltage settings register */
#define DA1470X_CHARGER_CHARGER_JEITA_V_OVP                (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_JEITA_V_OVP_OFFSET) /* JEITA-compliant OVP settings register */
#define DA1470X_CHARGER_CHARGER_JEITA_V_PRECHARGE          (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_JEITA_V_PRECHARGE_OFFSET) /* JEITA-compliant Pre-Charge voltage settings register */
#define DA1470X_CHARGER_CHARGER_JEITA_V_REPLENISH          (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_JEITA_V_REPLENISH_OFFSET) /* JEITA-compliant Replenish settings register */
#define DA1470X_CHARGER_CHARGER_LOCK                       (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_LOCK_OFFSET) /* Charger HW lock register */
#define DA1470X_CHARGER_CHARGER_PRE_CHARGE_TIMER           (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_PRE_CHARGE_TIMER_OFFSET) /* Maximum pre-charge time limit register */
#define DA1470X_CHARGER_CHARGER_PWR_UP_TIMER               (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_PWR_UP_TIMER_OFFSET) /* Charger power-up settling timer register */
#define DA1470X_CHARGER_CHARGER_STATE_IRQ_CLR              (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_STATE_IRQ_CLR_OFFSET) /* Interrupt clear register of Charger FSM IRQs */
#define DA1470X_CHARGER_CHARGER_STATE_IRQ_MASK             (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_STATE_IRQ_MASK_OFFSET) /* Mask register of Charger FSM IRQs */
#define DA1470X_CHARGER_CHARGER_STATE_IRQ_STATUS           (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_STATE_IRQ_STATUS_OFFSET) /* Status register of Charger FSM IRQs */
#define DA1470X_CHARGER_CHARGER_STATUS                     (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_STATUS_OFFSET) /* Charger main status register */
#define DA1470X_CHARGER_CHARGER_SWLOCK                     (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_SWLOCK_OFFSET) /* Charger SW lock register */
#define DA1470X_CHARGER_CHARGER_TBAT_COMP_TIMER            (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_TBAT_COMP_TIMER_OFFSET) /* Battery temperature (main) comparator timer register */
#define DA1470X_CHARGER_CHARGER_TBAT_MON_TIMER             (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_TBAT_MON_TIMER_OFFSET) /* Battery temperature monitor interval timer register */
#define DA1470X_CHARGER_CHARGER_TDIE_COMP_TIMER            (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_TDIE_COMP_TIMER_OFFSET) /* Die temperature comparator timer register */
#define DA1470X_CHARGER_CHARGER_TEMPSET2_PARAM             (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_TEMPSET2_PARAM_OFFSET) /* Charger battery temperature settings register (Cooler, Warmer). */
#define DA1470X_CHARGER_CHARGER_TEMPSET_PARAM              (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_TEMPSET_PARAM_OFFSET) /* Charger battery temperature settings register */
#define DA1470X_CHARGER_CHARGER_THOT_COMP_TIMER            (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_THOT_COMP_TIMER_OFFSET) /* Battery temperature comparator timer register for "Hot" zone */
#define DA1470X_CHARGER_CHARGER_TOTAL_CHARGE_TIMER         (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_TOTAL_CHARGE_TIMER_OFFSET) /* Maximum total charge time limit register */
#define DA1470X_CHARGER_CHARGER_VBAT_COMP_TIMER            (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_VBAT_COMP_TIMER_OFFSET) /* Main Vbat comparator timer register */
#define DA1470X_CHARGER_CHARGER_VOLTAGE_PARAM              (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_VOLTAGE_PARAM_OFFSET) /* Charger voltage settings register */
#define DA1470X_CHARGER_CHARGER_VOLTAGE_STATUS             (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_VOLTAGE_STATUS_OFFSET) /* Charger voltage status register */
#define DA1470X_CHARGER_CHARGER_VOVP_COMP_TIMER            (DA1470X_CHARGER_BASE + DA1470X_CHARGER_CHARGER_VOVP_COMP_TIMER_OFFSET) /* Vbat OVP comparator timer register */
...
#define CHARGER_CC_CHARGE_TIMER_MASK                       (0x7FFF << 16) /* Returns the current value of the CC-Charge timeout counter, running at a 1-Hz cl */
#define CHARGER_CC_CHARGE_TIMER_POS                        (16) /* Returns the current value of the CC-Charge timeout counter, running at a 1-Hz cl */
...
#define CHARGER_EOC_TRIGGER                                (1U << 28) /* 0: Edge-sensitive End-of-Charge detection support is enabled (default). The Char */
...
#define CHARGER_JEITA_SUPPORT_DISABLED                     (1U << 12) /* 0: Charger's JEITA FSM monitoring the battery temperature checks also if battery */
...
#define CHARGER_CHARGE_TIMERS_HALT_ENABLE                  (1U << 9) /* 0: Charge timeout timers continue running when charging is disabled because of a */
#define CHARGER_STOP_CHARGE_TIMERS                         (1U << 8) /* 0: Charger's Pre-Charge, CC, CV and Total charge timeout timers are ticking prop */
#define CHARGER_NTC_LOW_DISABLE                            (1U << 7) /* 0: Charging is disabled when the battery temperature is found to have reached th */
#define CHARGER_TBAT_PROT_ENABLE                           (1U << 6) /* 0: Battery temperature protection disabled 1: Battery temperature protection ena */
#define CHARGER_TDIE_ERROR_RESUME                          (1U << 5) /* 0: FSM will not resume from a Die temperature error. Consequently, its state wil */
#define CHARGER_TDIE_PROT_ENABLE                           (1U << 4) /* 0: Die temperature protection is disabled, thus charging will not be disabled by */
#define CHARGER_CHARGER_RESUME                             (1U << 3) /* 0: Charger's FSM is not enable to resume from a charge timeout error or a Vbat O */
#define CHARGER_CHARGER_BYPASS                             (1U << 2) /* 0: Charger's FSM is active and running, notifying SW upon switching between its  */
#define CHARGER_CHARGE_START                               (1U << 1) /* 0: Charger's FSM is disabled, FSM stays at "DISABLED" state 1: Charger's FSM is  */
#define CHARGER_CHARGER_ENABLE                             (1U << 0) /* 0: Charger's analogue circuitry is powered-down 1: Charger's analogue circuitry  */
...
#define CHARGER_I_END_OF_CHARGE_MASK                       (0x7 << 12) /* End-of-Charge current setting, ranging from 6 %("000") to 20 % ("111") of the ch */
#define CHARGER_I_END_OF_CHARGE_POS                        (12) /* End-of-Charge current setting, ranging from 6 %("000") to 20 % ("111") of the ch */
#define CHARGER_I_PRECHARGE_MASK                           (0x3F << 6) /* This bit-field determines the Pre-Charge current, in mA, ranging from 0.5 to 72  */
#define CHARGER_I_PRECHARGE_POS                            (6) /* This bit-field determines the Pre-Charge current, in mA, ranging from 0.5 to 72  */
#define CHARGER_I_CHARGE_MASK                              (0x3F << 0) /* This bit-field determines the charge current range, in mA. The range is from 5 m */
#define CHARGER_I_CHARGE_POS                               (0) /* This bit-field determines the charge current range, in mA. The range is from 5 m */
...
#define CHARGER_CV_CHARGE_TIMER_MASK                       (0x7FFF << 16) /* Returns the current value of the CV-Charge timeout counter, running at a 1-Hz cl */
#define CHARGER_CV_CHARGE_TIMER_POS                        (16) /* Returns the current value of the CV-Charge timeout counter, running at a 1-Hz cl */
...
#define CHARGER_PRE_CHARGE_TIMER_MASK                      (0x7FFF << 16) /* Returns the current value of the Pre-Charge timeout counter, running at a 1-Hz c */
#define CHARGER_PRE_CHARGE_TIMER_POS                       (16) /* Returns the current value of the Pre-Charge timeout counter, running at a 1-Hz c */
...
#define CHARGER_TBAT_MON_TIMER_MASK                        (0x3FF << 16) /* This is the battery temperature monitoring timer, counting with the Charger's 1- */
#define CHARGER_TBAT_MON_TIMER_POS                         (16) /* This is the battery temperature monitoring timer, counting with the Charger's 1- */
...
#define CHARGER_TOTAL_CHARGE_TIMER_MASK                    (0xFFFF << 16) /* Returns the current value of the overall charge timeout counter, running at a 1- */
#define CHARGER_TOTAL_CHARGE_TIMER_POS                     (16) /* Returns the current value of the overall charge timeout counter, running at a 1- */
...
#define CHARGER_VBAT_COMP_SETTLING_MASK                    (0x3FF << 0) /* Settling time threshold (in ms) for the Vbat comparator checking Vbat vs the pro */
#define CHARGER_VBAT_COMP_SETTLING_POS                     (0) /* Settling time threshold (in ms) for the Vbat comparator checking Vbat vs the pro */
...
#define CHARGER_VBAT_OVP_COMP_SETTLING_MASK                (0x3FF << 0) /* Settling time threshold (in ms) for the Vbat comparator checking Vbat vs the pro */
#define CHARGER_VBAT_OVP_COMP_SETTLING_POS                 (0) /* Settling time threshold (in ms) for the Vbat comparator checking Vbat vs the pro */
