...
#ifndef __DA1470X_LCDC_H
#define __DA1470X_LCDC_H
...
#define DA1470X_LCDC_LCDC_BACKPORCHXY_OFFSET      0x001C /* Back Porch X and Y */
#define DA1470X_LCDC_LCDC_BGCOLOR_OFFSET          0x0008 /* Background Color */
#define DA1470X_LCDC_LCDC_BLANKINGXY_OFFSET       0x0018 /* Blanking X and Y */
#define DA1470X_LCDC_LCDC_CLKCTRL_CG_OFFSET       0x01A8 /* Controls the CLock Gaters and the routing of format and pixel clock */
#define DA1470X_LCDC_LCDC_CLKCTRL_OFFSET          0x0004 /* Clock Divider */
#define DA1470X_LCDC_LCDC_COLMOD_OFFSET           0x0100 /* Color mode status register */
#define DA1470X_LCDC_LCDC_CONF_OFFSET             0x00F0 /* Supported config */
#define DA1470X_LCDC_LCDC_CRC_OFFSET              0x0184 /* CRC check */
#define DA1470X_LCDC_LCDC_DBIB_CFG_OFFSET         0x0028 /* MIPI DBIB Config Register */
#define DA1470X_LCDC_LCDC_DBIB_CMD_OFFSET         0x00E8 /* MIPI DBIB Command Register */
#define DA1470X_LCDC_LCDC_DBIB_RDAT_OFFSET        0x00EC /* Data read by DBI Type-B/SPI interface */
#define DA1470X_LCDC_LCDC_FMTCTRL_2_OFFSET        0x01A4 /* DBI and JDI format control */
#define DA1470X_LCDC_LCDC_FMTCTRL_3_OFFSET        0x01AC /* JDI format control */
#define DA1470X_LCDC_LCDC_FMTCTRL_OFFSET          0x01A0 /* DBI and JDI format control */
#define DA1470X_LCDC_LCDC_FRONTPORCHXY_OFFSET     0x0014 /* Front Porch X and Y */
#define DA1470X_LCDC_LCDC_GPIO_OFFSET             0x002C /* General Purpose IO (8-bits) */
#define DA1470X_LCDC_LCDC_IDREG_OFFSET            0x00F4 /* Identification Register */
#define DA1470X_LCDC_LCDC_INTERRUPT_OFFSET        0x00F8 /* Interrupt Register */
#define DA1470X_LCDC_LCDC_LAYER0_BASEADDR_OFFSET  0x003C /* Layer0 Base Addr */
#define DA1470X_LCDC_LCDC_LAYER0_MODE_OFFSET      0x0030 /* Layer0 Mode */
#define DA1470X_LCDC_LCDC_LAYER0_RESXY_OFFSET     0x0044 /* Layer0 Res XY */
#define DA1470X_LCDC_LCDC_LAYER0_SIZEXY_OFFSET    0x0038 /* Layer0 Size XY */
#define DA1470X_LCDC_LCDC_LAYER0_STARTXY_OFFSET   0x0034 /* Layer0 Start XY */
#define DA1470X_LCDC_LCDC_LAYER0_STRIDE_OFFSET    0x0040 /* Layer0 Stride */
#define DA1470X_LCDC_LCDC_LAYER1_BASEADDR_OFFSET  0x005C /* Layer1 Base Addr */
#define DA1470X_LCDC_LCDC_LAYER1_MODE_OFFSET      0x0050 /* Layer1 Mode */
#define DA1470X_LCDC_LCDC_LAYER1_RESXY_OFFSET     0x0064 /* Layer1 Res XY */
#define DA1470X_LCDC_LCDC_LAYER1_SIZEXY_OFFSET    0x0058 /* Layer1 Size XY */
#define DA1470X_LCDC_LCDC_LAYER1_STARTXY_OFFSET   0x0054 /* Layer0 Start XY */
#define DA1470X_LCDC_LCDC_LAYER1_STRIDE_OFFSET    0x0060 /* Layer1 Stride */
#define DA1470X_LCDC_LCDC_MODE_OFFSET             0x0000 /* Display Mode */
#define DA1470X_LCDC_LCDC_PALETTE_255_OFFSET      0x07FC /* Global palette/gamma correction */
#define DA1470X_LCDC_LCDC_PALETTE_BASE_OFFSET     0x0400 /* Global palette/gamma correction */
#define DA1470X_LCDC_LCDC_RESXY_OFFSET            0x000C /* Resolution X,Y */
#define DA1470X_LCDC_LCDC_STARTXY_OFFSET          0x0024 /* Specifies the start position of the very first frame */
#define DA1470X_LCDC_LCDC_STATUS_OFFSET           0x00FC /* Status Register */

/* Register addresses *******************************************************/

#define DA1470X_LCDC_BASE                         0x30030000 /* LCDC registers */

#define DA1470X_LCDC_LCDC_BACKPORCHXY             (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_BACKPORCHXY_OFFSET) /* Back Porch X and Y */
#define DA1470X_LCDC_LCDC_BGCOLOR                 (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_BGCOLOR_OFFSET) /* Background Color */
#define DA1470X_LCDC_LCDC_BLANKINGXY              (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_BLANKINGXY_OFFSET) /* Blanking X and Y */
#define DA1470X_LCDC_LCDC_CLKCTRL_CG              (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_CLKCTRL_CG_OFFSET) /* Controls the CLock Gaters and the routing of format and pixel clock */
#define DA1470X_LCDC_LCDC_CLKCTRL                 (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_CLKCTRL_OFFSET) /* Clock Divider */
#define DA1470X_LCDC_LCDC_COLMOD                  (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_COLMOD_OFFSET) /* Color mode status register */
#define DA1470X_LCDC_LCDC_CONF                    (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_CONF_OFFSET) /* Supported config */
#define DA1470X_LCDC_LCDC_CRC                     (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_CRC_OFFSET) /* CRC check */
#define DA1470X_LCDC_LCDC_DBIB_CFG                (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_DBIB_CFG_OFFSET) /* MIPI DBIB Config Register */
#define DA1470X_LCDC_LCDC_DBIB_CMD                (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_DBIB_CMD_OFFSET) /* MIPI DBIB Command Register */
#define DA1470X_LCDC_LCDC_DBIB_RDAT               (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_DBIB_RDAT_OFFSET) /* Data read by DBI Type-B/SPI interface */
#define DA1470X_LCDC_LCDC_FMTCTRL_2               (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_FMTCTRL_2_OFFSET) /* DBI and JDI format control */
#define DA1470X_LCDC_LCDC_FMTCTRL_3               (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_FMTCTRL_3_OFFSET) /* JDI format control */
#define DA1470X_LCDC_LCDC_FMTCTRL                 (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_FMTCTRL_OFFSET) /* DBI and JDI format control */
#define DA1470X_LCDC_LCDC_FRONTPORCHXY            (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_FRONTPORCHXY_OFFSET) /* Front Porch X and Y */
#define DA1470X_LCDC_LCDC_GPIO                    (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_GPIO_OFFSET) /* General Purpose IO (8-bits) */
#define DA1470X_LCDC_LCDC_IDREG                   (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_IDREG_OFFSET) /* Identification Register */
#define DA1470X_LCDC_LCDC_INTERRUPT               (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_INTERRUPT_OFFSET) /* Interrupt Register */
#define DA1470X_LCDC_LCDC_LAYER0_BASEADDR         (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER0_BASEADDR_OFFSET) /* Layer0 Base Addr */
#define DA1470X_LCDC_LCDC_LAYER0_MODE             (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER0_MODE_OFFSET) /* Layer0 Mode */
#define DA1470X_LCDC_LCDC_LAYER0_RESXY            (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER0_RESXY_OFFSET) /* Layer0 Res XY */
#define DA1470X_LCDC_LCDC_LAYER0_SIZEXY           (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER0_SIZEXY_OFFSET) /* Layer0 Size XY */
#define DA1470X_LCDC_LCDC_LAYER0_STARTXY          (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER0_STARTXY_OFFSET) /* Layer0 Start XY */
#define DA1470X_LCDC_LCDC_LAYER0_STRIDE           (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER0_STRIDE_OFFSET) /* Layer0 Stride */
#define DA1470X_LCDC_LCDC_LAYER1_BASEADDR         (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER1_BASEADDR_OFFSET) /* Layer1 Base Addr */
#define DA1470X_LCDC_LCDC_LAYER1_MODE             (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER1_MODE_OFFSET) /* Layer1 Mode */
#define DA1470X_LCDC_LCDC_LAYER1_RESXY            (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER1_RESXY_OFFSET) /* Layer1 Res XY */
#define DA1470X_LCDC_LCDC_LAYER1_SIZEXY           (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER1_SIZEXY_OFFSET) /* Layer1 Size XY */
#define DA1470X_LCDC_LCDC_LAYER1_STARTXY          (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER1_STARTXY_OFFSET) /* Layer0 Start XY */
#define DA1470X_LCDC_LCDC_LAYER1_STRIDE           (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_LAYER1_STRIDE_OFFSET) /* Layer1 Stride */
#define DA1470X_LCDC_LCDC_MODE                    (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_MODE_OFFSET) /* Display Mode */
#define DA1470X_LCDC_LCDC_PALETTE_255             (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_PALETTE_255_OFFSET) /* Global palette/gamma correction */
#define DA1470X_LCDC_LCDC_PALETTE_BASE            (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_PALETTE_BASE_OFFSET) /* Global palette/gamma correction */
#define DA1470X_LCDC_LCDC_RESXY                   (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_RESXY_OFFSET) /* Resolution X,Y */
#define DA1470X_LCDC_LCDC_STARTXY                 (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_STARTXY_OFFSET) /* Specifies the start position of the very first frame */
#define DA1470X_LCDC_LCDC_STATUS                  (DA1470X_LCDC_BASE + DA1470X_LCDC_LCDC_STATUS_OFFSET) /* Status Register */
...
#define LCDC_BPORCH_X_MASK                        (0xFFFF << 16) /* Back porch X (pixel clocks) */
#define LCDC_BPORCH_X_POS                         (16) /* Back porch X (pixel clocks) */
#define LCDC_BPORCH_Y_MASK                        (0xFFFF << 0) /* Back porch Y (lines) */
#define LCDC_BPORCH_Y_POS                         (0) /* Back porch Y (lines) */
...
#define LCDC_BLANKING_X_MASK                      (0xFFFF << 16) /* Blanking period X (HSYNC pulse length) */
#define LCDC_BLANKING_X_POS                       (16) /* Blanking period X (HSYNC pulse length) */
#define LCDC_BLANKING_Y_MASK                      (0xFFFF << 0) /* Blanking period Y (VSYNC lines) */
#define LCDC_BLANKING_Y_POS                       (0) /* Blanking period Y (VSYNC lines) */

/* LCDC_CLKCTRL_CG Register */

#define LCDC_LCDC_SWAP_PIX_FORMAT_CLK             (1U << 2) /* Pixel generation and format clock swap */
#define LCDC_LCDC_INV_CLK_POLARITY                (1U << 1) /* Invert (output) clock polarity */
...
#define LCDC_CONF_MASK                            (0xFFFFFFFF << 0) /* 0 bit : Indicates that Global Gamma/Palette is enabled 1 bit : Indicates that fi */
#define LCDC_CONF_POS                             (0) /* 0 bit : Indicates that Global Gamma/Palette is enabled 1 bit : Indicates that fi */
...
#define LCDC_SPID_JDI                             (1U << 18) /* Enable JDI over SPI */
...
#define LCDC_QSPI_SERIAL_CMD_TRANS                (1U << 27) /* When sets to 1, switch to serial transmission of the command. Applicable only fo */
...
#define LCDC_FMTCTRL_2_MASK                       (0xFFFFFFFF << 0) /* Bits Description When DBI-Type B Interface is selected: Bits Description 31-16 b */
#define LCDC_FMTCTRL_2_POS                        (0) /* Bits Description When DBI-Type B Interface is selected: Bits Description 31-16 b */

/* LCDC_FMTCTRL_3 Register */

#define LCDC_XRST_HIGH_STATE_MASK                 (0x3FF << 0) /* Set the high state of XRST signal in multiple of VCK */
#define LCDC_XRST_HIGH_STATE_POS                  (0) /* Set the high state of XRST signal in multiple of VCK */

/* LCDC_FMTCTRL Register */

#define LCDC_FMTCTRL_MASK                         (0xFFFFFFFF << 0) /* When DBI-Type B Interface is selected: Bits Description 31-22 bits: Reserved 21- */
#define LCDC_FMTCTRL_POS                          (0) /* When DBI-Type B Interface is selected: Bits Description 31-22 bits: Reserved 21- */

/* LCDC_FRONTPORCHXY Register */

#define LCDC_FPORCH_X_MASK                        (0xFFFF << 16) /* Front porch X (pixel clocks) */
#define LCDC_FPORCH_X_POS                         (16) /* Front porch X (pixel clocks) */
#define LCDC_FPORCH_Y_MASK                        (0xFFFF << 0) /* Front porch Y (lines) */
#define LCDC_FPORCH_Y_POS                         (0) /* Front porch Y (lines) */
...
#define LCDC_LCDC_ID_MASK                         (0xFFFFFFFF << 0) /* Identification register */
#define LCDC_LCDC_ID_POS                          (0) /* Identification register */
...
#define LCDC_FE_IRQ_EN                            (1U << 4) /* Frame end interrupt enabled */
#define LCDC_TE_IRQ_EN                            (1U << 3) /* Tearing enable interrupt enabled */
...
#define LCDC_L0_ASSERT_HLOCK_DMA                  (1U << 27) /* When set to 1, HLOCK signal on AHB DMAs is asserted */
...
#define LCDC_L0_DMA_PREFETCH_MASK                 (0x7 << 25) /* Specify the DMA prefetch Level in layer 0 * 0x000 : 0 DMA rows (default) * 0x001 */
#define LCDC_L0_DMA_PREFETCH_POS                  (25) /* Specify the DMA prefetch Level in layer 0 * 0x000 : 0 DMA rows (default) * 0x001 */
...
#define LCDC_L0_NO_16BEAT_BURST                   (1U << 16) /* When set to 1 forbids INCR16 bursts in layer 0 */
...
#define LCDC_L1_ASSERT_HLOCK_DMA                  (1U << 27) /* When set to 1, HLOCK signal on AHB DMAs is asserted */
...
#define LCDC_L1_DMA_PREFETCH_MASK                 (0x7 << 25) /* Specify the DMA prefetch Level in layer 1 * 0x000 : 0 DMA rows (default) * 0x001 */
#define LCDC_L1_DMA_PREFETCH_POS                  (25) /* Specify the DMA prefetch Level in layer 1 * 0x000 : 0 DMA rows (default) * 0x001 */
...
#define LCDC_L1_NO_16BEAT_BURST                   (1U << 16) /* When set to 1 forbids INCR16 bursts in layer 1 */
...
#define LCDC_UNDERRUN_PREVENTION_EN               (1U << 18) /* When set to 1, underrun prevention is enabled for interfaces that support this */
...
#define LCDC_SPI_RD_WR_OP                         (1U << 16) /* Indicates read/write operation on SPI */
...
#define LCDC_STAT_DE                              (1U << 1) /* Indicates the DE signal status (0 or 1) at the current time of reading */
#define LCDC_STAT_ACTIVE                          (1U << 0) /* Active (When not in vertical blanking) */

#endif /* __DA1470X_LCDC_H */
