...
#define DA1470X_CRG_AUD_BASE                  0x50030000 /* CRG_AUD registers */

#define DA1470X_CRG_AUD_PCM_DIV               (DA1470X_CRG_AUD_BASE + DA1470X_CRG_AUD_PCM_DIV_OFFSET) /* PCM divider and enables */
#define DA1470X_CRG_AUD_PCM_FDIV              (DA1470X_CRG_AUD_BASE + DA1470X_CRG_AUD_PCM_FDIV_OFFSET) /* PCM fractional division register */
#define DA1470X_CRG_AUD_PDM_DIV               (DA1470X_CRG_AUD_BASE + DA1470X_CRG_AUD_PDM_DIV_OFFSET) /* PDM divider and enables */
#define DA1470X_CRG_AUD_SRC_DIV               (DA1470X_CRG_AUD_BASE + DA1470X_CRG_AUD_SRC_DIV_OFFSET) /* SRC divider and enables */
...
#define CRG_AUD_PCM_FDIV_MASK                 (0xFFFF << 0) /* These bits define the fractional division part of the PCM clock. The left most 1 */
#define CRG_AUD_PCM_FDIV_POS                  (0) /* These bits define the fractional division part of the PCM clock. The left most 1 */
