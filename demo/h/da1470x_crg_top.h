...
#define DA1470X_CRG_TOP_BIAS_VREF_SEL_OFFSET       0x00E8 /* No description available. */
#define DA1470X_CRG_TOP_BOD_CTRL_OFFSET            0x0060 /* Brown Out Detection control register */
#define DA1470X_CRG_TOP_BOD_STATUS_OFFSET          0x0064 /* No description available. */
#define DA1470X_CRG_TOP_CLK_AMBA_OFFSET            0x0000 /* HCLK, PCLK, divider and clock gates */
#define DA1470X_CRG_TOP_CLK_CMAC_SWITCH_OFFSET     0x0004 /* Clock switching register for CMAC clock domain */
...
#define DA1470X_CRG_TOP_CLK_SNC_CTRL_OFFSET        0x002C /* No description available. */
...
#define DA1470X_CRG_TOP_DISCHARGE_RAIL_OFFSET      0x00D4 /* Immediate rail resetting. There is no LDO/DCDC gating */
#define DA1470X_CRG_TOP_LCD_EXT_CTRL_OFFSET        0x0034 /* No description available. */
#define DA1470X_CRG_TOP_P0_PAD_LATCH_OFFSET        0x0070 /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P0_RESET_PAD_LATCH_OFFSET  0x0078 /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P0_SET_PAD_LATCH_OFFSET    0x0074 /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P1_PAD_LATCH_OFFSET        0x007C /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P1_RESET_PAD_LATCH_OFFSET  0x0084 /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P1_SET_PAD_LATCH_OFFSET    0x0080 /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P2_PAD_LATCH_OFFSET        0x0088 /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P2_RESET_PAD_LATCH_OFFSET  0x0090 /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P2_SET_PAD_LATCH_OFFSET    0x008C /* Control the state retention of the GPIO ports */
...
#define DA1470X_CRG_TOP_POWER_LVL_OFFSET           0x00F8 /* No description available. */
...
#define DA1470X_CRG_TOP_SW_V18F_OFFSET             0x00E4 /* No description available. */
...
#define DA1470X_CRG_TOP_WAKEUP_HIBERN_OFFSET       0x00E0 /* No description available. */

/* Register addresses *******************************************************/

#define DA1470X_CRG_TOP_BASE                       0x50000000 /* CRG_TOP registers */

#define DA1470X_CRG_TOP_ANA_STATUS                 (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_ANA_STATUS_OFFSET) /* Analog Signals Status Register */
#define DA1470X_CRG_TOP_BANDGAP                    (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_BANDGAP_OFFSET) /* bandgap trimming */
#define DA1470X_CRG_TOP_BIAS_VREF_SEL              (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_BIAS_VREF_SEL_OFFSET) /* No description available. */
#define DA1470X_CRG_TOP_BOD_CTRL                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_BOD_CTRL_OFFSET) /* Brown Out Detection control register */
#define DA1470X_CRG_TOP_BOD_STATUS                 (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_BOD_STATUS_OFFSET) /* No description available. */
#define DA1470X_CRG_TOP_CLK_AMBA                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_AMBA_OFFSET) /* HCLK, PCLK, divider and clock gates */
#define DA1470X_CRG_TOP_CLK_CMAC_SWITCH            (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_CMAC_SWITCH_OFFSET) /* Clock switching register for CMAC clock domain */
#define DA1470X_CRG_TOP_CLK_CTRL                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_CTRL_OFFSET) /* Clock control register */
#define DA1470X_CRG_TOP_CLK_RADIO                  (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_RADIO_OFFSET) /* Radio PLL control register */
#define DA1470X_CRG_TOP_CLK_RCHS                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_RCHS_OFFSET) /* Fast RC control register */
#define DA1470X_CRG_TOP_CLK_RCLP                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_RCLP_OFFSET) /* 32/512 kHz RC oscillator register */
#define DA1470X_CRG_TOP_CLK_RCX                    (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_RCX_OFFSET) /* RCX-oscillator control register */
#define DA1470X_CRG_TOP_CLK_RTCDIV                 (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_RTCDIV_OFFSET) /* Divisor for RTC 100Hz clock */
#define DA1470X_CRG_TOP_CLK_SNC_CTRL               (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_SNC_CTRL_OFFSET) /* No description available. */
#define DA1470X_CRG_TOP_CLK_SWITCH2XTAL            (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_SWITCH2XTAL_OFFSET) /* Switches clock from RC32M to XTAL32M */
#define DA1470X_CRG_TOP_CLK_TMR                    (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_TMR_OFFSET) /* Clock control for the timers */
#define DA1470X_CRG_TOP_CLK_XTAL32K                (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_CLK_XTAL32K_OFFSET) /* 32 kHz XTAL oscillator register */
#define DA1470X_CRG_TOP_DISCHARGE_RAIL             (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_DISCHARGE_RAIL_OFFSET) /* Immediate rail resetting. There is no LDO/DCDC gating */
#define DA1470X_CRG_TOP_LCD_EXT_CTRL               (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_LCD_EXT_CTRL_OFFSET) /* No description available. */
#define DA1470X_CRG_TOP_P0_PAD_LATCH               (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P0_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P0_RESET_PAD_LATCH         (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P0_RESET_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P0_SET_PAD_LATCH           (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P0_SET_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P1_PAD_LATCH               (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P1_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P1_RESET_PAD_LATCH         (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P1_RESET_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P1_SET_PAD_LATCH           (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P1_SET_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P2_PAD_LATCH               (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P2_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P2_RESET_PAD_LATCH         (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P2_RESET_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_P2_SET_PAD_LATCH           (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_P2_SET_PAD_LATCH_OFFSET) /* Control the state retention of the GPIO ports */
#define DA1470X_CRG_TOP_PMU_CTRL                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_PMU_CTRL_OFFSET) /* Power Management Unit control register */
#define DA1470X_CRG_TOP_PMU_SLEEP                  (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_PMU_SLEEP_OFFSET) /* Configures the sleep/wakeup strategy */
#define DA1470X_CRG_TOP_POR_CTRL                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_POR_CTRL_OFFSET) /* Controls the POR on VBAT */
#define DA1470X_CRG_TOP_POR_PIN                    (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_POR_PIN_OFFSET) /* Selects a GPIO pin for POR generation */
#define DA1470X_CRG_TOP_POR_TIMER                  (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_POR_TIMER_OFFSET) /* Time for POR to happen */
#define DA1470X_CRG_TOP_POWER_CTRL                 (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_POWER_CTRL_OFFSET) /* Power control register */
#define DA1470X_CRG_TOP_POWER_LVL                  (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_POWER_LVL_OFFSET) /* No description available. */
#define DA1470X_CRG_TOP_RAM_PWR_CTRL               (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_RAM_PWR_CTRL_OFFSET) /* Control power state of System RAMS */
#define DA1470X_CRG_TOP_RESET_STAT                 (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_RESET_STAT_OFFSET) /* Reset status register */
#define DA1470X_CRG_TOP_RST_CTRL                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_RST_CTRL_OFFSET) /* Reset control register */
#define DA1470X_CRG_TOP_SECURE_BOOT                (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_SECURE_BOOT_OFFSET) /* Controls secure booting */
#define DA1470X_CRG_TOP_SLP_MAP                    (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_SLP_MAP_OFFSET) /* Map signals on GPIOs during sleep */
#define DA1470X_CRG_TOP_SW_V18F                    (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_SW_V18F_OFFSET) /* No description available. */
#define DA1470X_CRG_TOP_SYS_CTRL                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_SYS_CTRL_OFFSET) /* System Control register */
#define DA1470X_CRG_TOP_SYS_STAT                   (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_SYS_STAT_OFFSET) /* System status register */
#define DA1470X_CRG_TOP_VBUS_IRQ_CLEAR             (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_VBUS_IRQ_CLEAR_OFFSET) /* Clear pending IRQ register */
#define DA1470X_CRG_TOP_VBUS_IRQ_MASK              (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_VBUS_IRQ_MASK_OFFSET) /* IRQ masking */
#define DA1470X_CRG_TOP_WAKEUP_HIBERN              (DA1470X_CRG_TOP_BASE + DA1470X_CRG_TOP_WAKEUP_HIBERN_OFFSET) /* No description available. */
...
#define CRG_TOP_FLAG_LDO_V30_COMBINED_OK           (1U << 29) /* When high, ldo_v30 OR ldo_v30_ret is active (for VAD system) */
#define CRG_TOP_XOR_DOUT_WAKEUP_PADS               (1U << 28) /* Will be the result of XOR operation of the hibernation wake-up pads outputs comb */
...
#define CRG_TOP_FLAG_IBIAS_TRIM                    (1U << 25) /* 10 nA Iref trimming, high when on-chip current is larger than reference current */
...
#define CRG_TOP_COMP_VBUS_PLUGIN                   (1U << 7) /* VBUS is connected (VBUS > 2.5 V) */
#define CRG_TOP_COMP_VSYS_NEAR_VLED                (1U << 6) /* BOOST_VLED_SEL=0x0 : VSYS>4.3 BOOST_VLED_SEL=0x1 : VSYS>4.55 BOOST_VLED_SEL=0x2  */
#define CRG_TOP_COMP_VBUS_ABOVE_VSYS               (1U << 5) /* VBUS>VSYS+0.05 V */
#define CRG_TOP_COMP_VSYS_OK                       (1U << 4) /* VSYS> 2.45 V */
#define CRG_TOP_COMP_VBAT_OK                       (1U << 3) /* VBAT> 2.7 V */
#define CRG_TOP_COMP_VBUS_OK                       (1U << 2) /* 1: VBUS> 4.1 V 0: VBUS<3.4 V */
#define CRG_TOP_POR_VSYS_OK                        (1U << 1) /* When high, VSYS is higher then POR threshold */
#define CRG_TOP_POR_V30_OK                         (1U << 0) /* When high, V30 is higher then POR threshold */
...
#define CRG_TOP_BOD_STATUS_CLEAR                   (1U << 0) /* Clears BOD_STATUS_REG when this bit is 1 for more than 2 ms. It must be 0 to reg */
...
#define CRG_TOP_CMAC_RUNNING_ON_XTAL               (1U << 2) /* This bit is 1 when the CMAC_CLK is enabled, and the switch is set in the XTAL32M */
#define CRG_TOP_CMAC_RUNNING_ON_DIVN               (1U << 1) /* This bit is 1 when the CMAC_CLK is enabled, and the switch is set in the DIVN_CL */
...
#define CRG_TOP_VAD_CLK_SEL                        (1U << 6) /* Selects the clock for the VAD. 0: Select RCLP clock (normalized for ~32 kHz) 1:  */
#define CRG_TOP_USB_CLK_SRC                        (1U << 4) /* Selects the USB source clock 0 : USB PLL 48 MHz clk 1 : DIVN clk, to be used in  */
#define CRG_TOP_LP_CLK_SEL_MASK                    (0x3 << 2) /* Sets the clock source of the LowerPower clock 0x0: RCLP 0x1: RCX 0x2: XTAL32K th */
#define CRG_TOP_LP_CLK_SEL_POS                     (2) /* Sets the clock source of the LowerPower clock 0x0: RCLP 0x1: RCX 0x2: XTAL32K th */
#define CRG_TOP_SYS_CLK_SEL_MASK                   (0x3 << 0) /* Selects the clock source. 0x0 : XTAL32M 0x1 : RCHS 0x2 : RCLP 0x3 : The PLL 160  */
#define CRG_TOP_SYS_CLK_SEL_POS                    (0) /* Selects the clock source. 0x0 : XTAL32M 0x1 : RCHS 0x2 : RCLP 0x3 : The PLL 160  */
...
#define CRG_TOP_RCHS_SPEED_MASK                    (0x3 << 22) /* Selects speed of RCHS output 0b00: 32 MHz, by dividing 96 / 3. 0b01: 96 MHz, by  */
#define CRG_TOP_RCHS_SPEED_POS                     (22) /* Selects speed of RCHS output 0b00: 32 MHz, by dividing 96 / 3. 0b01: 96 MHz, by  */
...
#define CRG_TOP_RCHS_BIAS_MASK                     (0xF << 1) /* Bias adjustment. Avoid higher bias trim settings (for example, 0xF), the resulti */
#define CRG_TOP_RCHS_BIAS_POS                      (1) /* Bias adjustment. Avoid higher bias trim settings (for example, 0xF), the resulti */
#define CRG_TOP_RCHS_ENABLE                        (1U << 0) /* Enables the HighSpeed RC oscillator. Setting this bit will always-enable the osc */

/* CLK_RCLP Register */

#define CRG_TOP_RCLP_LOW_SPEED_FORCE               (1U << 5) /* Forces RCLP in 32-kHz mode. If this bit is 0 then RCLP frequency is 512 kHz */
...
#define CRG_TOP_RCLP_ENABLE                        (1U << 0) /* Enables the 32-kHz RC oscillator. Do not disable this bit, as deep/extended slee */
...
#define CRG_TOP_RTC_DIV_INT_MASK                   (0x1FF << 10) /* Integer divisor part for RTC 100 Hz generation */
#define CRG_TOP_RTC_DIV_INT_POS                    (10) /* Integer divisor part for RTC 100 Hz generation */
#define CRG_TOP_RTC_DIV_FRAC_MASK                  (0x3FF << 0) /* Fractional divisor part for RTC 100 Hz generation. if RTC_DIV_DENOM=1, <RTC_DIV_ */
#define CRG_TOP_RTC_DIV_FRAC_POS                   (0) /* Fractional divisor part for RTC 100 Hz generation. if RTC_DIV_DENOM=1, <RTC_DIV_ */
...
#define CRG_TOP_XTAL32K_CUR_MASK                   (0xF << 3) /* Bias current for the 32-kHz XTAL oscillator. 0000 is minimum, 1111 is maximum, 0 */
#define CRG_TOP_XTAL32K_CUR_POS                    (3) /* Bias current for the 32-kHz XTAL oscillator. 0000 is minimum, 1111 is maximum, 0 */
...
#define CRG_TOP_XTAL32K_ENABLE                     (1U << 0) /* Enables the 32-kHz XTAL oscillator */

/* DISCHARGE_RAIL Register */

#define CRG_TOP_RESET_V18F                         (1U << 5) /* 1: enables immediate discharging of the V18F rail. Note that the source is not d */
#define CRG_TOP_RESET_V30                          (1U << 3) /* 1: enables immediate discharging of the V30 rail. Note that the source is not di */
...
#define CRG_TOP_RETAIN_DCACHE                      (1U << 11) /* Selects the retainability of the dcache block while PD_CTRL is off. 1 is retaina */
...
#define CRG_TOP_RETAIN_CACHE                       (1U << 7) /* Selects the retainability of the cache block during deep sleep. 1 is retainable, */
#define CRG_TOP_SYS_SLEEP                          (1U << 6) /* Put the System powerdomain (PD_SYS) in powerdown. If this bit is 1, and there is */
...
#define CRG_TOP_ENABLE_FAST_SWITCH                 (1U << 30) /* Enables early clock switching upon event detection to speed up the wake-up time */
#define CRG_TOP_VLED_BYPASS_REFRESH_TIME_MASK      (0x7F << 23) /* Determines how long the VLED bypass switch is closed when VSYS near VLED flag an */
#define CRG_TOP_VLED_BYPASS_REFRESH_TIME_POS       (23) /* Determines how long the VLED bypass switch is closed when VSYS near VLED flag an */
#define CRG_TOP_BOD_SLEEP_INTERVAL_MASK            (0xF << 19) /* This is the interval at which the BOD comparators/POR will be checked during sle */
#define CRG_TOP_BOD_SLEEP_INTERVAL_POS             (19) /* This is the interval at which the BOD comparators/POR will be checked during sle */
...
#define CRG_TOP_POR_VSYS_HYST_SEL                  (1U << 10) /* Selects POR_VSYS threshold level, when hysteresis is disabled (see POR_VSYS_DISA */
...
#define CRG_TOP_EN_RCX_SUPPLY_BIAS                 (1U << 27) /* RCX supply bias switch for calibration. This bit needs to be 0 before entering h */
#define CRG_TOP_DCDC_BOOST_CLAMP_EN                (1U << 24) /* Enables clamp circuit between V_LED and ground in the boost converter to bleed o */
...
#define CRG_TOP_LDO_START_DISABLE                  (1U << 0) /* Disables ldo start. */
...
#define CRG_TOP_V18_LEVEL                          (1U << 16) /* Level setting for V18 rail: 0: 1.2 V 1: 1.8 V */
#define CRG_TOP_V14_LEVEL_MASK                     (0x3 << 14) /* Level setting for V14 rail: 0: 1.2 V 1: 1.3 V 2: 1.4 V 3: 1.5 V */
#define CRG_TOP_V14_LEVEL_POS                      (14) /* Level setting for V14 rail: 0: 1.2 V 1: 1.3 V 2: 1.4 V 3: 1.5 V */
#define CRG_TOP_V12_SLEEP_LEVEL_MASK               (0x3 << 12) /* Level setting for V12 rail in sleep: 0: 0.75 V 1: 0.9 V 2: 1.2 V 3: reserved */
#define CRG_TOP_V12_SLEEP_LEVEL_POS                (12) /* Level setting for V12 rail in sleep: 0: 0.75 V 1: 0.9 V 2: 1.2 V 3: reserved */
#define CRG_TOP_V12_LEVEL_MASK                     (0x3 << 10) /* Level setting for V12 rail: 0: 0.75 V 1: 0.9 V 2: 1.2 V 3: reserved */
#define CRG_TOP_V12_LEVEL_POS                      (10) /* Level setting for V12 rail: 0: 0.75 V 1: 0.9 V 2: 1.2 V 3: reserved */
#define CRG_TOP_V30_SLEEP_LEVEL_MASK               (0x3 << 8) /* Level setting for V30 in sleep: 0x0: 3.0 V 0x1: reserved 0x2: 3.3 V 0x3: 3.3 V */
#define CRG_TOP_V30_SLEEP_LEVEL_POS                (8) /* Level setting for V30 in sleep: 0x0: 3.0 V 0x1: reserved 0x2: 3.3 V 0x3: 3.3 V */
#define CRG_TOP_V30_LEVEL_MASK                     (0x3 << 6) /* Level setting for V30: 0x0: 3.0 V 0x1: reserved 0x2: 3.3 V 0x3: 3.3 V */
#define CRG_TOP_V30_LEVEL_POS                      (6) /* Level setting for V30: 0x0: 3.0 V 0x1: reserved 0x2: 3.3 V 0x3: 3.3 V */
...
#define CRG_TOP_BANDGAP_SLP_MAP                    (1U << 6) /* Setting this bit will:  - map bandgap_enable to P0_20 - map (wokenup OR cmac_slp */
...
#define CRG_TOP_CACHERAM_MUX                       (1U << 10) /* Controls accessiblity of Cache RAM (incl. enabling/disabling of the Cache Contro */
...
#define CRG_TOP_SNC_DEBUGGER_ENABLE                (1U << 5) /* Enable the SNC debugger. If not set, the SWDIO and SW_CLK can be used as gpio po */
#define CRG_TOP_REMAP_INTVECT                      (1U << 3) /* 0: normal operation 1: If ARM is in address range 0 - 0x1FF then the address is  */
...
#define CRG_TOP_VBUS_IRQ_EN_RISE                   (1U << 1) /* Setting this bit to 1 enables VBUS_IRQ generation when the VBUS starts to ramp a */
#define CRG_TOP_VBUS_IRQ_EN_FALL                   (1U << 0) /* Setting this bit to 1 enables VBUS_IRQ generation when the VBUS starts to fall b */

/* WAKEUP_HIBERN Register */

#define CRG_TOP_HIBERNATION_ENABLE                 (1U << 12) /* Enable hibernation mode */
#define CRG_TOP_WAKEUP_PD_EN_MASK                  (0xF << 6) /* Enables pull-down for GPIO[n] during hibernation Bit 0: P0_20 Bit 1: P0_29 Bit 2 */
#define CRG_TOP_WAKEUP_PD_EN_POS                   (6) /* Enables pull-down for GPIO[n] during hibernation Bit 0: P0_20 Bit 1: P0_29 Bit 2 */
